...
export const ENEMY_SPRITE_REGISTRY: Record<EnemyType, EnemySpriteConfig> = {
  [EnemyType.Skeleton]: {
    ...
    textureKey: "skeleton",
    assetPath: "/src/assets/characters/classes/skeleton/skeleton.png",
  ...
  [EnemyType.Minotaur]: {
    ...
    assetPath: "/src/assets/characters/classes/minotauro/minotaur.png",
  ...
  [EnemyType.Hedgehog]: {
    ...
    textureKey: "hedgehog",
    assetPath: "/src/assets/characters/classes/hedgehog/hedgehog.png",
  ...
  [EnemyType.Wolf]: {
    ...
    textureKey: "lobos",
    assetPath: "/src/assets/characters/classes/lobos/wolfs.png",
